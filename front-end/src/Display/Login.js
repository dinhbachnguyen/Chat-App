...
import { Link, Grid, IconButton, Tooltip } from '@mui/material';
      ...
      >
        ...
        <Grid item xs>
          <div css = {{textAlign: 'center'}}>
            <Tooltip title = 'Login Via Github' arrow onClick={redirect}>
              <IconButton>
                <GitHubIcon css={{height: '100px', width: '100px',fill: '#fff',}} />
              </IconButton>
            </Tooltip>
          </div>
        </Grid>
